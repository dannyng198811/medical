// Generated on 2015-11-20 using generator-php 0.4.0
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            livereload: {
                options: {livereload: 99},
                files: [
                    '<%= yeoman.app %>/_/css/**/*.css',
                    '<%= yeoman.app %>/_/js/**/*',
                    '<%= yeoman.app %>/_/img/**/*',
                    '<%= yeoman.app %>/**/*.php',
                    '<%= yeoman.app %>/_/tpls/*.html'
                ]
            }
        },
        ...
        processhtml: {
            dist: {
                files: {
                    '<%= yeoman.dist %>/_/tpls/footer.html': ['<%= yeoman.dist %>/_/tpls/footer.html']
                }
            }
        },
