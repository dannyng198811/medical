  ...
  <div class="field mtb2">
   ...
   <div class="field mtb2">
    ...
    <div class="field mtb2">
       ...
       <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="Facebook专页">
          <label>Facebook专页</label>
        </div>
        
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="网上广告">
          <label>网上广告</label>
        </div>
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="Google/Yahoo 关键字">
          <label>Google/Yahoo 关键字</label>
        </div>
        
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="电视/报章/杂志">
          <label>电视/报章/杂志</label>
        </div>
        
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="海报/宣传单">
          <label>海报/宣传单</label>
        </div>
        
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="朋友介绍">
          <label>朋友介绍</label>
        </div>
        
        <div class="ui checkbox mtb08">
          <input name="source[]" type="checkbox" value="其他">
          <label>其他</label>
        </div>
